...
param_true = [1.1e4, 0.9e4, 0.8e4, 5e4]
...
if optim == 'grad':
    ...
    initial_params = [1e4, 1e4, 1e4, 4.8e4]
    tol = 1e-3600
    ...
    F_hist.insert(0, initial_params[3])
    ...
    plt.xlabel("Iterations")
    plt.hlines(param_true[3], 0, result.nit-1, color='r', label='True Value')
...
with open("result_full_f48.json", "w") as outfile: 
