...
for s in range(0, steps, 1):
    ...
    gui.circles(x_np_reshape[[2,4]].reshape((-1, dim)), color=0x198C19, radius=1.5)
    gui.circles(x_np_reshape[[3,5]].reshape((-1, dim)), color=0x198C19, radius=1.5)
