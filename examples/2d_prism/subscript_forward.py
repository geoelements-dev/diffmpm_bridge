...
parser.add_argument("init_E", type=str)
args = parser.parse_args()

# Extract arguments
width = int(args.width)
init_E = int(args.init_E)
...
np.save(f'results/E_{width}_{int(init_E)}.npy', E.to_numpy())
np.save(f'results/s1_{width}_{int(init_E)}.npy', strain.to_numpy())
np.save(f'results/s_{width}_{int(init_E)}.npy', strain2.to_numpy())
np.save(f'results/disp_{width}_{int(init_E)}.npy', disp.to_numpy())
np.save(f'results/x_{width}_{int(init_E)}.npy', x.to_numpy())
